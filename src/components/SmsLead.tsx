...
export default function SmsLead({ leadId, leadName, phoneNumber, dialpadToken, dialpadUserId, onSent }: SmsLeadProps) {
  ...
  const [customTitle, setCustomTitle] = useState('Custom follow-up')
