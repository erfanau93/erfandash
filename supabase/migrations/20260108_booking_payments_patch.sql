-- Safety patch to ensure payment tracking columns exist in booking_occurrences.
-- This addresses "Could not find the 'payment_amount_cents' column" errors if the
-- previous migration was missed when the UI tries to write payment details.
